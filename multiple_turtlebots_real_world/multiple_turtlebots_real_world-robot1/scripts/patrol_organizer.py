...
#     
    def __init__(self, availableRobots=['robot_1'], listOfPositions={'robot_1':[(-3.50,-3.75), (-1.0,-4.50)]}):
        rospy.loginfo('coordinator initialization')
        self.nextPositionIndex = {'robot_1':0}
...
def main():
    ...
    parser.add_argument("--robot_to_control", default="robot_1", help="robot's name. should be unique in order to coordinate multiple robots. default: robot_1 ")
    args, unknown = parser.parse_known_args()
    coordinator = PatrolCoordinator(availableRobots=['robot_1'])
