...
#     
    def __init__(self, availableRobots=['robot_0', 'robot_1','robot_2'], listOfPositions={'robot_0':[(1.5,-1.0), (2.0,-1.5)], 'robot_1':[ (1.5,2.5), (2.5,1.5)], 'robot_2':[ (3,4), (4,3)]}):
        rospy.loginfo('coordinator initialization')
        self.nextPositionIndex = {'robot_0':0, 'robot_1':1, 'robot_2':0}
